...
import com.anthooop.colision.feature.meeting.data.DefaultArbitrationsRepository
...
val meetingModule: Module = module {
    ...
    single<ArbitrationsRepository> {
        DefaultArbitrationsRepository(supabase = get(), arbitrationDao = get())
    }
